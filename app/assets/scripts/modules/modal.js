class Modal {
  constructor() {
    ...
    this.clsBtn = document.querySelector(".modal__close");
    this.events();
  }
  events() {
    //xaaj baigaag ajiglax
    this.clsBtn.addEventListener("click", () => this.closeModal());
    //keyboardin ymr neg towchluur darsan esexiig ajiglax
